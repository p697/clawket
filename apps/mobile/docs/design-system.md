...
| `Sheet` | Shared bottom/iPad presentation chrome, handle, backdrop, title (or a `titleContent` node such as the Session Panel Agent pill), and close action |
