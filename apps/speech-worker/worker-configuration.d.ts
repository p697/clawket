/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/speech-worker/wrangler.jsonc --strict-vars=false apps/speech-worker/worker-configuration.d.ts` (hash: b7c388d6be6dd4d68750d0db147ad6fc)
// Runtime types generated with workerd@1.20260910.1 2026-09-19 nodejs_compat
interface __BaseEnv_Env {
	ALIYUN_SPEECH_URL: string;
	SPEECH_ENABLED: string;
	ADMISSION: DurableObjectNamespace<import("./src/index").SpeechAdmission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpeechAdmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALIYUN_SPEECH_URL" | "SPEECH_ENABLED">> {}
}
